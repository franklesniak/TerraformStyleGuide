...
### Pinned Registry URLs in Comments Go Stale

> For the rule itself, see [Terraform Registry Documentation URLs in Comments](STYLE_GUIDE.md#terraform-registry-documentation-urls-in-comments) in the main guide.
