...
$scriptBlockContextModuleDefinition = {
    ...
    $versionCandidateContext = [System.Version]'1.0.20260924.0'
    ...
    $arrHelperModules = @(Microsoft.PowerShell.Core\Get-Module -Name 'TerraformStyleGuideCandidateArtifact_1_0_20260924_0' -All)
...
$strContextModuleName = 'TerraformStyleGuideCandidateContext_1_0_20260924_0'
