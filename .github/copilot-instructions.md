# Repository instructions for Terraform Style Guide
...
The following files are **generated artifacts** and must not be edited by hand.
They are rebuilt automatically by the CI build script whenever `STYLE_GUIDE.md`
or `STYLE_GUIDE_RATIONALE.md` changes:

- `copilot-instructions.md` (root) — generated from `STYLE_GUIDE.md`
